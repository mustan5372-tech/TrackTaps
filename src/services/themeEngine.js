...
export const THEMES = {
  ...
  sunset: {
    ...
    '--bg-primary': '#0f0a0a',
    '--bg-secondary': '#1a0f0f',
    '--surface': 'rgba(26, 15, 15, 0.5)',
    '--surface-glass': 'rgba(26, 15, 15, 0.8)',
    '--surface-bright': 'rgba(249, 115, 22, 0.05)',
    '--primary': '#f97316',
    ...
    '--shadow-premium': '0 0 30px rgba(249, 115, 22, 0.2)'
  },
  emerald: {
    '--bg-deep': '#011c15',
    '--bg-primary': '#022c22',
    ...
    '--surface-glass': 'rgba(6, 78, 59, 0.8)',
    '--surface-bright': 'rgba(16, 185, 129, 0.05)',
    '--primary': '#10b981',
    ...
    '--shadow-premium': '0 0 30px rgba(16, 185, 129, 0.2)'
  },
  custom: {
    '--bg-deep': '#020617',
    '--bg-primary': '#0f172a',
